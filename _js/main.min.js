...
$(function() {
    ...
    function scrollToAnchor(anchorId) {
        console.debug("Trying to scrool to anchor #" + anchorId);
        var anchorElement = document.getElementById(anchorId);
        if (anchorElement) {
            console.debug("Found, trying...");
    ...
    function updateContentFromUrl(url) {
        ...
        loadContentFromUrl(url, newContent => {
            ...
            } else currContent.innerHTML = "<h3>Sorry, there was a problem loading the content!</h3>(" + error + ")";
        });
    }
        ...
        if (hashIndex !== -1) {
            ...
            loadContentFromUrl(url, newContent => {
                ...
                if (startHeading) {
                    ...
                    onSuccess(content);
                } else console.error("Start heading not found.");
            }, error => {
                error(error);
            });
        } else console.error("Invalid URL: No anchor found.");
    }
