...
Basically we follow [[jekyll|jekyll-dir-struct]] and [[minimal-mistake|mm-dir-struct]]
...
3. [[Install node.js|mm-javascripts]] \
   It's needed only if you have to [modify and re-pack](#modify-and-repack-js) the .js script files
